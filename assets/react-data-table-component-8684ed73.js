...
`;function Dn({columns:e=[],conditionalRowStyles:t=[],defaultExpanded:o=!1,defaultExpanderDisabled:a=!1,dense:l=!1,expandableIcon:i,expandableRows:s=!1,expandableRowsComponent:g,expandableRowsComponentProps:b,expandableRowsHideExpander:y,expandOnRowClicked:u=!1,expandOnRowDoubleClicked:w=!1,highlightOnHover:j=!1,id:R,expandableInheritConditionalStyles:f,keyField:H,onRowClicked:x=D,onRowDoubleClicked:P=D,onRowMouseEnter:$=D,onRowMouseLeave:S=D,onRowExpandToggled:O=D,onSelectedRow:L=D,pointerOnHover:A=!1,row:C,rowCount:v,rowIndex:U,selectableRowDisabled:M=null,selectableRows:N=!1,selectableRowsComponent:Q,selectableRowsComponentProps:k,selectableRowsHighlight:ne=!1,selectableRowsSingle:ce=!1,selected:oe,striped:ae=!1,draggingColumnId:Pe,onDragStart:De,onDragOver:He,onDragEnd:$e,onDragEnter:G,onDragLeave:he}){const[V,we]=n.useState(o);n.useEffect(()=>{we(o)},[o]);const Z=n.useCallback(()=>{we(!V),O(!V,C)},[V,O,C]),Fe=A||s&&(u||w),je=n.useCallback(E=>{E.target&&E.target.getAttribute("data-tag")==="allowRowEvents"&&(x(C,E),!a&&s&&u&&Z())},[a,u,s,Z,x,C]),fe=n.useCallback(E=>{E.target&&E.target.getAttribute("data-tag")==="allowRowEvents"&&(P(C,E),!a&&s&&w&&Z())},[a,w,s,Z,P,C]),Ie=n.useCallback(E=>{$(C,E)},[$,C]),Y=n.useCallback(E=>{S(C,E)},[S,C]),q=ie(C,H),{style:xe,classNames:Ce}=xt(C,t,["rdt_TableRow"]),Te=ne&&oe,Le=f?xe:{},Ae=ae&&U%2==0;return n.createElement(n.Fragment,null,n.createElement(Pn,{id:`row-${R}`,role:"row",striped:Ae,highlightOnHover:j,pointerOnHover:!a&&Fe,dense:l,onClick:je,onDoubleClick:fe,onMouseEnter:Ie,onMouseLeave:Y,className:Ce,selected:Te,style:xe},N&&n.createElement(xn,{name:`select-row-${q}`,keyField:H,row:C,rowCount:v,selected:oe,selectableRowsComponent:Q,selectableRowsComponentProps:k,selectableRowDisabled:M,selectableRowsSingle:ce,onSelectedRow:L}),s&&!y&&n.createElement(vn,{id:q,expandableIcon:i,expanded:V,row:C,onToggled:Z,disabled:a}),e.map(E=>E.omit?null:n.createElement(wn,{id:`cell-${E.id}-${q}`,key:`cell-${E.id}-${q}`,dataTag:E.ignoreRowClick||E.button?null:"allowRowEvents",column:E,row:C,rowIndex:U,isDragging:be(Pe,E.id),onDragStart:De,onDragOver:He,onDragEnd:$e,onDragEnter:G,onDragLeave:he}))),s&&V&&n.createElement(En,{key:`expander-${q}`,data:C,extendedRowStyle:Le,extendedClassNames:Ce,ExpanderComponent:g,expanderComponentProps:b}))}const Hn=p.span`
	padding: 2px;
	color: inherit;
	flex-grow: 0;
	flex-shrink: 0;
...
`,$n=({sortActive:e,sortDirection:t})=>h.createElement(Hn,{sortActive:e,sortDirection:t},"▲"),Fn=p(yt)`
...
`,Tn=p.div`
	...
	white-space: nowrap;
	text-overflow: ellipsis;
`;var Ln=n.memo(function({column:e,disabled:t,draggingColumnId:o,selectedColumn:a={},sortDirection:l,sortIcon:i,sortServer:s,pagination:g,paginationServer:b,persistSelectedOnSort:y,selectableRowsVisibleOnly:u,onSort:w,onDragStart:j,onDragOver:R,onDragEnd:f,onDragEnter:H,onDragLeave:x}){n.useEffect(()=>{typeof e.selector=="string"&&console.error(`Warning: ${e.selector} is a string based column selector which has been deprecated as of v7 and will be removed in v8. Instead, use a selector function e.g. row => row[field]...`)},[]);const[P,$]=n.useState(!1),S=n.useRef(null);if(n.useEffect(()=>{S.current&&$(S.current.scrollWidth>S.current.clientWidth)},[P]),e.omit)return null;const O=()=>{if(!e.sortable&&!e.selector)return;let k=l;be(a.id,e.id)&&(k=l===X.ASC?X.DESC:X.ASC),w({type:"SORT_CHANGE",sortDirection:k,selectedColumn:e,clearSelectedOnSort:g&&b&&!y||s||u})},L=k=>n.createElement($n,{sortActive:k,sortDirection:l}),A=()=>n.createElement("span",{className:[l,"__rdt_custom_sort_icon__"].join(" ")},i),C=!(!e.sortable||!be(a.id,e.id)),v=!e.sortable||t,U=e.sortable&&!i&&!e.right,M=e.sortable&&!i&&e.right,N=e.sortable&&i&&!e.right,Q=e.sortable&&i&&e.right;return n.createElement(Fn,{"data-column-id":e.id,className:"rdt_TableCol",headCell:!0,allowOverflow:e.allowOverflow,button:e.button,compact:e.compact,grow:e.grow,hide:e.hide,maxWidth:e.maxWidth,minWidth:e.minWidth,right:e.right,center:e.center,width:e.width,draggable:e.reorder,isDragging:be(e.id,o),onDragStart:j,onDragOver:R,onDragEnd:f,onDragEnter:H,onDragLeave:x},e.name&&n.createElement(In,{"data-column-id":e.id,"data-sort-id":e.id,role:"columnheader",tabIndex:0,className:"rdt_TableCol_Sortable",onClick:v?void 0:O,onKeyPress:v?void 0:k=>{k.key==="Enter"&&O()},sortActive:!v&&C,disabled:v},!v&&Q&&A(),!v&&M&&L(C),typeof e.name=="string"?n.createElement(Tn,{title:P?e.name:void 0,ref:S,"data-column-id":e.id},e.name):e.name,!v&&N&&A(),!v&&U&&L(C)))});const An=p(de)`
	flex: 0 0 48px;
	justify-content: center;
	align-items: center;
	user-select: none;
...
`,Yn=e=>{var{align:t="right",wrapContent:o=!0}=e,a=St(e,["align","wrapContent"]);return n.createElement(Qn,Object.assign({align:t,wrapContent:o},a))},Jn=p.div`
	display: flex;
	flex-direction: column;
`,Kn=p.div`
	position: relative;
...
`,so=p(Et)`
	margin: 0 4px;
`;var co=n.memo(function({rowsPerPage:e,rowCount:t,currentPage:o,direction:a=r.direction,paginationRowsPerPageOptions:l=r.paginationRowsPerPageOptions,paginationIconLastPage:i=r.paginationIconLastPage,paginationIconFirstPage:s=r.paginationIconFirstPage,paginationIconNext:g=r.paginationIconNext,paginationIconPrevious:b=r.paginationIconPrevious,paginationComponentOptions:y=r.paginationComponentOptions,onChangeRowsPerPage:u=r.onChangeRowsPerPage,onChangePage:w=r.onChangePage}){const j=(()=>{const k=typeof window=="object";function ne(){return{width:k?window.innerWidth:void 0,height:k?window.innerHeight:void 0}}const[ce,oe]=n.useState(ne);return n.useEffect(()=>{if(!k)return()=>null;function ae(){oe(ne())}return window.addEventListener("resize",ae),()=>window.removeEventListener("resize",ae)},[]),ce})(),R=vt(a),f=j.width&&j.width>599,H=pe(t,e),x=o*e,P=x-e+1,$=o===1,S=o===H,O=Object.assign(Object.assign({},ao),y),L=o===H?`${P}-${t} ${O.rangeSeparatorText} ${t}`:`${P}-${x} ${O.rangeSeparatorText} ${t}`,A=n.useCallback(()=>w(o-1),[o,w]),C=n.useCallback(()=>w(o+1),[o,w]),v=n.useCallback(()=>w(1),[w]),U=n.useCallback(()=>w(pe(t,e)),[w,t,e]),M=n.useCallback(k=>u(Number(k.target.value),o),[o,u]),N=l.map(k=>n.createElement("option",{key:k,value:k},k));O.selectAllRowsItem&&N.push(n.createElement("option",{key:-1,value:t},O.selectAllRowsItemText));const Q=n.createElement(oo,{onChange:M,defaultValue:e,"aria-label":O.rowsPerPageText},N);return n.createElement(lo,{className:"rdt_Pagination"},!O.noRowsPerPage&&f&&n.createElement(n.Fragment,null,n.createElement(so,null,O.rowsPerPageText),Q),f&&n.createElement(io,null,L),n.createElement(ro,null,n.createElement(Ee,{id:"pagination-first-page",type:"button","aria-label":"First Page","aria-disabled":$,onClick:v,disabled:$,isRTL:R},s),n.createElement(Ee,{id:"pagination-previous-page",type:"button","aria-label":"Previous Page","aria-disabled":$,onClick:A,disabled:$,isRTL:R},b),!f&&Q,n.createElement(Ee,{id:"pagination-next-page",type:"button","aria-label":"Next Page","aria-disabled":S,onClick:C,disabled:S,isRTL:R},g),n.createElement(Ee,{id:"pagination-last-page",type:"button","aria-label":"Last Page","aria-disabled":S,onClick:U,disabled:S,isRTL:R},i)))});const te=(e,t)=>{const o=n.useRef(!0);n.useEffect(()=>{o.current?o.current=!1:e()},t)};var go=function(e){return function(t){return!!t&&typeof t=="object"}(e)&&!function(t){var o=Object.prototype.toString.call(t);return o==="[object RegExp]"||o==="[object Date]"||function(a){return a.$$typeof===uo}(t)}(e)},uo=typeof Symbol=="function"&&Symbol.for?Symbol.for("react.element"):60103;function me(e,t){return t.clone!==!1&&t.isMergeableObject(e)?se((o=e,Array.isArray(o)?[]:{}),e,t):e;var o}function po(e,t,o){return e.concat(t).map(function(a){return me(a,o)})}function mt(e){return Object.keys(e).concat(function(t){return Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(t).filter(function(o){return t.propertyIsEnumerable(o)}):[]}(e))}function ht(e,t){try{return t in e}catch{return!1}}function bo(e,t,o){var a={};return o.isMergeableObject(e)&&mt(e).forEach(function(l){a[l]=me(e[l],o)}),mt(t).forEach(function(l){(function(i,s){return ht(i,s)&&!(Object.hasOwnProperty.call(i,s)&&Object.propertyIsEnumerable.call(i,s))})(e,l)||(ht(e,l)&&o.isMergeableObject(t[l])?a[l]=function(i,s){if(!s.customMerge)return se;var g=s.customMerge(i);return typeof g=="function"?g:se}(l,o)(e[l],t[l],o):a[l]=me(t[l],o))}),a}function se(e,t,o){(o=o||{}).arrayMerge=o.arrayMerge||po,o.isMergeableObject=o.isMergeableObject||go,o.cloneUnlessOtherwiseSpecified=me;var a=Array.isArray(t);return a===Array.isArray(e)?a?o.arrayMerge(e,t,o):bo(e,t,o):me(t,o)}se.all=function(e,t){if(!Array.isArray(e))throw new Error("first argument should be an array");return e.reduce(function(o,a){return se(o,a,t)},{})};var mo=se;const wt={text:{primary:"rgba(0, 0, 0, 0.87)",secondary:"rgba(0, 0, 0, 0.54)",disabled:"rgba(0, 0, 0, 0.38)"},background:{default:"#FFFFFF"},context:{background:"#e3f2fd",text:"rgba(0, 0, 0, 0.87)"},divider:{default:"rgba(0,0,0,.12)"},button:{default:"rgba(0,0,0,.54)",focus:"rgba(0,0,0,.12)",hover:"rgba(0,0,0,.12)",disabled:"rgba(0, 0, 0, .18)"},selected:{default:"#e3f2fd",text:"rgba(0, 0, 0, 0.87)"},highlightOnHover:{default:"#EEEEEE",text:"rgba(0, 0, 0, 0.87)"},striped:{default:"#FAFAFA",text:"rgba(0, 0, 0, 0.87)"}},ft={default:wt,light:wt,dark:{text:{primary:"#FFFFFF",secondary:"rgba(255, 255, 255, 0.7)",disabled:"rgba(0,0,0,.12)"},background:{default:"#424242"},context:{background:"#E91E63",text:"#FFFFFF"},divider:{default:"rgba(81, 81, 81, 1)"},button:{default:"#FFFFFF",focus:"rgba(255, 255, 255, .54)",hover:"rgba(255, 255, 255, .12)",disabled:"rgba(255, 255, 255, .18)"},selected:{default:"rgba(0, 0, 0, .7)",text:"#FFFFFF"},highlightOnHover:{default:"rgba(0, 0, 0, .7)",text:"#FFFFFF"},striped:{default:"rgba(0, 0, 0, .87)",text:"#FFFFFF"}}};function ho(e,t,o,a){const[l,i]=n.useState(()=>gt(e)),[s,g]=n.useState(""),b=n.useRef("");te(()=>{i(gt(e))},[e]);const y=n.useCallback(x=>{var P,$,S;const{attributes:O}=x.target,L=(P=O.getNamedItem("data-column-id"))===null||P===void 0?void 0:P.value;L&&(b.current=((S=($=l[Se(l,L)])===null||$===void 0?void 0:$.id)===null||S===void 0?void 0:S.toString())||"",g(b.current))},[l]),u=n.useCallback(x=>{var P;const{attributes:$}=x.target,S=(P=$.getNamedItem("data-column-id"))===null||P===void 0?void 0:P.value;if(S&&b.current&&S!==b.current){const O=Se(l,b.current),L=Se(l,S),A=[...l];A[O]=l[L],A[L]=l[O],i(A),t(A)}},[t,l]),w=n.useCallback(x=>{x.preventDefault()},[]),j=n.useCallback(x=>{x.preventDefault()},[]),R=n.useCallback(x=>{x.preventDefault(),b.current="",g("")},[]),f=function(x=!1){return x?X.ASC:X.DESC}(a),H=n.useMemo(()=>l[Se(l,o==null?void 0:o.toString())]||{},[o,l]);return{tableColumns:l,draggingColumnId:s,handleDragStart:y,handleDragEnter:u,handleDragOver:w,handleDragLeave:j,handleDragEnd:R,defaultSortDirection:f,defaultSortColumn:H}}var xo=n.memo(function(e){const{data:t=r.data,columns:o=r.columns,title:a=r.title,actions:l=r.actions,keyField:i=r.keyField,striped:s=r.striped,highlightOnHover:g=r.highlightOnHover,pointerOnHover:b=r.pointerOnHover,dense:y=r.dense,selectableRows:u=r.selectableRows,selectableRowsSingle:w=r.selectableRowsSingle,selectableRowsHighlight:j=r.selectableRowsHighlight,selectableRowsNoSelectAll:R=r.selectableRowsNoSelectAll,selectableRowsVisibleOnly:f=r.selectableRowsVisibleOnly,selectableRowSelected:H=r.selectableRowSelected,selectableRowDisabled:x=r.selectableRowDisabled,selectableRowsComponent:P=r.selectableRowsComponent,selectableRowsComponentProps:$=r.selectableRowsComponentProps,onRowExpandToggled:S=r.onRowExpandToggled,onSelectedRowsChange:O=r.onSelectedRowsChange,expandableIcon:L=r.expandableIcon,onChangeRowsPerPage:A=r.onChangeRowsPerPage,onChangePage:C=r.onChangePage,paginationServer:v=r.paginationServer,paginationServerOptions:U=r.paginationServerOptions,paginationTotalRows:M=r.paginationTotalRows,paginationDefaultPage:N=r.paginationDefaultPage,paginationResetDefaultPage:Q=r.paginationResetDefaultPage,paginationPerPage:k=r.paginationPerPage,paginationRowsPerPageOptions:ne=r.paginationRowsPerPageOptions,paginationIconLastPage:ce=r.paginationIconLastPage,paginationIconFirstPage:oe=r.paginationIconFirstPage,paginationIconNext:ae=r.paginationIconNext,paginationIconPrevious:Pe=r.paginationIconPrevious,paginationComponent:De=r.paginationComponent,paginationComponentOptions:He=r.paginationComponentOptions,responsive:$e=r.responsive,progressPending:G=r.progressPending,progressComponent:he=r.progressComponent,persistTableHead:V=r.persistTableHead,noDataComponent:we=r.noDataComponent,disabled:Z=r.disabled,noTableHead:Fe=r.noTableHead,noHeader:je=r.noHeader,fixedHeader:fe=r.fixedHeader,fixedHeaderScrollHeight:Ie=r.fixedHeaderScrollHeight,pagination:Y=r.pagination,subHeader:q=r.subHeader,subHeaderAlign:xe=r.subHeaderAlign,subHeaderWrap:Ce=r.subHeaderWrap,subHeaderComponent:Te=r.subHeaderComponent,noContextMenu:Le=r.noContextMenu,contextMessage:Ae=r.contextMessage,contextActions:E=r.contextActions,contextComponent:Ot=r.contextComponent,expandableRows:ye=r.expandableRows,onRowClicked:Be=r.onRowClicked,onRowDoubleClicked:Ge=r.onRowDoubleClicked,onRowMouseEnter:Ve=r.onRowMouseEnter,onRowMouseLeave:Ue=r.onRowMouseLeave,sortIcon:kt=r.sortIcon,onSort:Pt=r.onSort,sortFunction:Qe=r.sortFunction,sortServer:Me=r.sortServer,expandableRowsComponent:Dt=r.expandableRowsComponent,expandableRowsComponentProps:Ht=r.expandableRowsComponentProps,expandableRowDisabled:Ye=r.expandableRowDisabled,expandableRowsHideExpander:Je=r.expandableRowsHideExpander,expandOnRowClicked:$t=r.expandOnRowClicked,expandOnRowDoubleClicked:Ft=r.expandOnRowDoubleClicked,expandableRowExpanded:Ke=r.expandableRowExpanded,expandableInheritConditionalStyles:jt=r.expandableInheritConditionalStyles,defaultSortFieldId:It=r.defaultSortFieldId,defaultSortAsc:Tt=r.defaultSortAsc,clearSelectedRows:Xe=r.clearSelectedRows,conditionalRowStyles:Lt=r.conditionalRowStyles,theme:Ze=r.theme,customStyles:qe=r.customStyles,direction:ge=r.direction,onColumnOrderChange:At=r.onColumnOrderChange,className:Mt}=e,{tableColumns:et,draggingColumnId:tt,handleDragStart:nt,handleDragEnter:ot,handleDragOver:at,handleDragLeave:lt,handleDragEnd:rt,defaultSortDirection:_t,defaultSortColumn:zt}=ho(o,At,It,Tt),[{rowsPerPage:J,currentPage:_,selectedRows:_e,allSelected:it,selectedCount:st,selectedColumn:W,sortDirection:le,toggleOnSelectedRowsChange:Nt},ee]=n.useReducer(ln,{allSelected:!1,selectedCount:0,selectedRows:[],selectedColumn:zt,toggleOnSelectedRowsChange:!1,sortDirection:_t,currentPage:N,rowsPerPage:k,selectedRowsFlag:!1,contextMessage:r.contextMessage}),{persistSelectedOnSort:dt=!1,persistSelectedOnPageChange:Re=!1}=U,ct=!(!v||!Re&&!dt),Wt=Y&&!G&&t.length>0,Bt=De||co,Gt=n.useMemo(()=>((c={},m="default",T="default")=>{const z=ft[m]?m:T;return mo({table:{style:{color:(d=ft[z]).text.primary,backgroundColor:d.background.default}},tableWrapper:{style:{display:"table"}},responsiveWrapper:{style:{}},header:{style:{fontSize:"22px",color:d.text.primary,backgroundColor:d.background.default,minHeight:"56px",paddingLeft:"16px",paddingRight:"8px"}},subHeader:{style:{backgroundColor:d.background.default,minHeight:"52px"}},head:{style:{color:d.text.primary,fontSize:"12px",fontWeight:500}},headRow:{style:{backgroundColor:d.background.default,minHeight:"52px",borderBottomWidth:"1px",borderBottomColor:d.divider.default,borderBottomStyle:"solid"},denseStyle:{minHeight:"32px"}},headCells:{style:{paddingLeft:"16px",paddingRight:"16px"},draggingStyle:{cursor:"move"}},contextMenu:{style:{backgroundColor:d.context.background,fontSize:"18px",fontWeight:400,color:d.context.text,paddingLeft:"16px",paddingRight:"8px",transform:"translate3d(0, -100%, 0)",transitionDuration:"125ms",transitionTimingFunction:"cubic-bezier(0, 0, 0.2, 1)",willChange:"transform"},activeStyle:{transform:"translate3d(0, 0, 0)"}},cells:{style:{paddingLeft:"16px",paddingRight:"16px",wordBreak:"break-word"},draggingStyle:{}},rows:{style:{fontSize:"13px",fontWeight:400,color:d.text.primary,backgroundColor:d.background.default,minHeight:"48px","&:not(:last-of-type)":{borderBottomStyle:"solid",borderBottomWidth:"1px",borderBottomColor:d.divider.default}},denseStyle:{minHeight:"32px"},selectedHighlightStyle:{"&:nth-of-type(n)":{color:d.selected.text,backgroundColor:d.selected.default,borderBottomColor:d.background.default}},highlightOnHoverStyle:{color:d.highlightOnHover.text,backgroundColor:d.highlightOnHover.default,transitionDuration:"0.15s",transitionProperty:"background-color",borderBottomColor:d.background.default,outlineStyle:"solid",outlineWidth:"1px",outlineColor:d.background.default},stripedStyle:{color:d.striped.text,backgroundColor:d.striped.default}},expanderRow:{style:{color:d.text.primary,backgroundColor:d.background.default}},expanderCell:{style:{flex:"0 0 48px"}},expanderButton:{style:{color:d.button.default,fill:d.button.default,backgroundColor:"transparent",borderRadius:"2px",transition:"0.25s",height:"100%",width:"100%","&:hover:enabled":{cursor:"pointer"},"&:disabled":{color:d.button.disabled},"&:hover:not(:disabled)":{cursor:"pointer",backgroundColor:d.button.hover},"&:focus":{outline:"none",backgroundColor:d.button.focus},svg:{margin:"auto"}}},pagination:{style:{color:d.text.secondary,fontSize:"13px",minHeight:"56px",backgroundColor:d.background.default,borderTopStyle:"solid",borderTopWidth:"1px",borderTopColor:d.divider.default},pageButtonsStyle:{borderRadius:"50%",height:"40px",width:"40px",padding:"8px",margin:"px",cursor:"pointer",transition:"0.4s",color:d.button.default,fill:d.button.default,backgroundColor:"transparent","&:disabled":{cursor:"unset",color:d.button.disabled,fill:d.button.disabled},"&:hover:not(:disabled)":{backgroundColor:d.button.hover},"&:focus":{outline:"none",backgroundColor:d.button.focus}}},noData:{style:{display:"flex",alignItems:"center",justifyContent:"center",color:d.text.primary,backgroundColor:d.background.default}},progress:{style:{display:"flex",alignItems:"center",justifyContent:"center",color:d.text.primary,backgroundColor:d.background.default}}},c);var d})(qe,Ze),[qe,Ze]),Vt=n.useMemo(()=>Object.assign({},ge!=="auto"&&{dir:ge}),[ge]),I=n.useMemo(()=>{if(Me)return t;if(W!=null&&W.sortFunction&&typeof W.sortFunction=="function"){const c=W.sortFunction,m=le===X.ASC?c:(T,z)=>-1*c(T,z);return[...t].sort(m)}return function(c,m,T,z){return m?z&&typeof z=="function"?z(c.slice(0),m,T):c.slice(0).sort((d,ve)=>{let K,B;if(typeof m=="string"?(K=Ne(d,m),B=Ne(ve,m)):(K=m(d),B=m(ve)),T==="asc"){if(K<B)return-1;if(K>B)return 1}if(T==="desc"){if(K>B)return-1;if(K<B)return 1}return 0}):c}(t,W==null?void 0:W.selector,le,Qe)},[Me,W,le,t,Qe]),ue=n.useMemo(()=>{if(Y&&!v){const c=_*J,m=c-J;return I.slice(m,c)}return I},[_,Y,v,J,I]),Ut=n.useCallback(c=>{ee(c)},[]),Qt=n.useCallback(c=>{ee(c)},[]),Yt=n.useCallback(c=>{ee(c)},[]),Jt=n.useCallback((c,m)=>Be(c,m),[Be]),Kt=n.useCallback((c,m)=>Ge(c,m),[Ge]),Xt=n.useCallback((c,m)=>Ve(c,m),[Ve]),Zt=n.useCallback((c,m)=>Ue(c,m),[Ue]),re=n.useCallback(c=>ee({type:"CHANGE_PAGE",page:c,paginationServer:v,visibleOnly:f,persistSelectedOnPageChange:Re}),[v,Re,f]),qt=n.useCallback(c=>{const m=pe(M||ue.length,c),T=ze(_,m);v||re(T),ee({type:"CHANGE_ROWS_PER_PAGE",page:T,rowsPerPage:c})},[_,re,v,M,ue.length]);if(Y&&!v&&I.length>0&&ue.length===0){const c=pe(I.length,J),m=ze(_,c);re(m)}te(()=>{O({allSelected:it,selectedCount:st,selectedRows:_e.slice(0)})},[Nt]),te(()=>{Pt(W,le,I.slice(0))},[W,le]),te(()=>{C(_,M||I.length)},[_]),te(()=>{A(J,_)},[J]),te(()=>{re(N)},[N,Q]),te(()=>{if(Y&&v&&M>0){const c=pe(M,J),m=ze(_,c);_!==m&&re(m)}},[M]),n.useEffect(()=>{ee({type:"CLEAR_SELECTED_ROWS",selectedRowsFlag:Xe})},[w,Xe]),n.useEffect(()=>{if(!H)return;const c=I.filter(T=>H(T)),m=w?c.slice(0,1):c;ee({type:"SELECT_MULTIPLE_ROWS",keyField:i,selectedRows:m,totalRows:I.length,mergeSelections:ct})},[t,H]);const en=f?ue:I,tn=Re||w||R;return n.createElement(nn,{theme:Gt},!je&&(!!a||!!l)&&n.createElement(Vn,{title:a,actions:l,showMenu:!Le,selectedCount:st,direction:ge,contextActions:E,contextComponent:Ot,contextMessage:Ae}),q&&n.createElement(Yn,{align:xe,wrapContent:Ce},Te),n.createElement(Kn,Object.assign({responsive:$e,fixedHeader:fe,fixedHeaderScrollHeight:Ie,className:Mt},Vt),n.createElement(Xn,null,G&&!V&&n.createElement(bt,null,he),n.createElement(sn,{disabled:Z,className:"rdt_Table",role:"table"},!Fe&&(!!V||I.length>0&&!G)&&n.createElement(cn,{className:"rdt_TableHead",role:"rowgroup",fixedHeader:fe},n.createElement(gn,{className:"rdt_TableHeadRow",role:"row",dense:y},u&&(tn?n.createElement(de,{style:{flex:"0 0 48px"}}):n.createElement(Mn,{allSelected:it,selectedRows:_e,selectableRowsComponent:P,selectableRowsComponentProps:$,selectableRowDisabled:x,rowData:en,keyField:i,mergeSelections:ct,onSelectAllRows:Qt})),ye&&!Je&&n.createElement(Zn,null),et.map(c=>n.createElement(Ln,{key:c.id,column:c,selectedColumn:W,disabled:G||I.length===0,pagination:Y,paginationServer:v,persistSelectedOnSort:dt,selectableRowsVisibleOnly:f,sortDirection:le,sortIcon:kt,sortServer:Me,onSort:Ut,onDragStart:nt,onDragOver:at,onDragEnd:rt,onDragEnter:ot,onDragLeave:lt,draggingColumnId:tt})))),!I.length&&!G&&n.createElement(qn,null,we),G&&V&&n.createElement(bt,null,he),!G&&I.length>0&&n.createElement(Jn,{className:"rdt_TableBody",role:"rowgroup"},ue.map((c,m)=>{const T=ie(c,i),z=function(B=""){return typeof B!="number"&&(!B||B.length===0)}(T)?m:T,d=Oe(c,_e,i),ve=!!(ye&&Ke&&Ke(c)),K=!!(ye&&Ye&&Ye(c));return n.createElement(Dn,{id:z,key:z,keyField:i,"data-row-id":z,columns:et,row:c,rowCount:I.length,rowIndex:m,selectableRows:u,expandableRows:ye,expandableIcon:L,highlightOnHover:g,pointerOnHover:b,dense:y,expandOnRowClicked:$t,expandOnRowDoubleClicked:Ft,expandableRowsComponent:Dt,expandableRowsComponentProps:Ht,expandableRowsHideExpander:Je,defaultExpanderDisabled:K,defaultExpanded:ve,expandableInheritConditionalStyles:jt,conditionalRowStyles:Lt,selected:d,selectableRowsHighlight:j,selectableRowsComponent:P,selectableRowsComponentProps:$,selectableRowDisabled:x,selectableRowsSingle:w,striped:s,onRowExpandToggled:S,onRowClicked:Jt,onRowDoubleClicked:Kt,onRowMouseEnter:Xt,onRowMouseLeave:Zt,onSelectedRow:Yt,draggingColumnId:tt,onDragStart:nt,onDragOver:at,onDragEnd:rt,onDragEnter:ot,onDragLeave:lt})}))))),Wt&&n.createElement("div",null,n.createElement(Bt,{onChangePage:re,onChangeRowsPerPage:qt,rowCount:M||I.length,currentPage:_,rowsPerPage:J,direction:ge,paginationRowsPerPageOptions:ne,paginationIconLastPage:ce,paginationIconFirstPage:oe,paginationIconNext:ae,paginationIconPrevious:Pe,paginationComponentOptions:He})))});export{xo as Q};
